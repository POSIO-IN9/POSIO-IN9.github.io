      ...
      <div className="greet-main" id="greeting">
        <div className="greeting-main">
          <div className="greeting-text-div">
            <div>
              ...
              >
                ...
                <br/>
                <span className="greeting-text-intro">{greeting.intro}</span>
                {" "}
                {greeting.myname}
                {" "}
              ...
              <div className="tooltip-container" onClick={copyToClipboard}>
                ...
                <span id="alert" className="copy-alert">email 복사 완료!</span>
              </div>
              </div>
          ...
          <div className="greeting-image-div">
              <div className="myimg">
              <FlipImage frontImage={frontImage} backImage={backImage} size={350} />
              </div>
          </div>
        </div>
      </div>
